#!/usr/bin/env python3
"""
GitHub Workflow Best Practices - PowerPoint Generator
Creates a professional PowerPoint presentation with modern styling
"""
...
def create_presentation():
    ...
    agenda_items = [
        ("🔴 Current Pain Points", "5 min", "Identify and quantify our workflow challenges"),
        ("🟡 Root Cause Analysis", "3 min", "Understanding why these problems persist"),
        ("🟢 Solution Architecture", "10 min", "Comprehensive GitHub-based workflow system"),
        ("🎯 Live Demonstration", "7 min", "See the workflow in action"),
        ("📊 Implementation Roadmap", "5 min", "Your 30-day transformation plan")
    ]
    ...
    # Create two text boxes manually
    left = Inches(0.5)
    top = Inches(2)
    width = Inches(6)
    height = Inches(4.5)
    ...
    p = tf.add_paragraph()
    p.text = "📋 backlog → 📝 todo → 🏃 in-progress → 🚫 blocked → 👀 review → ✅ done"
    p.font.size = Pt(18)
    ...
    roadmap = [
        ...
        ("Week 3: Integration", "💬 Slack notifications | 📈 Analytics dashboard | 🔄 CI/CD pipeline"),
        ("Week 4: Optimization", "🎯 Refine workflows | 📊 Measure success | 🚀 Scale to all teams")
    ]
    ...
    p = tf.add_paragraph()
    p.text = "Demo: github.com/hanzlahabib/github-workflow-demo"
    p.font.size = Pt(18)
    
    p = tf.add_paragraph()
    p.text = "Office Hours: Thursdays 2-3 PM"
    p.font.size = Pt(18)
    ...
    prs.save('GitHub_Workflow_Best_Practices.pptx')
    print("✅ PowerPoint presentation created successfully!")
    print("📁 File saved as: GitHub_Workflow_Best_Practices.pptx")
